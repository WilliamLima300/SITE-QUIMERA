...
<body>
    ...
    <section>
        <div class="bloco1">
            ...
            <p> E estamos aqui para dar forma a ele. A Quimera Designer alia modernidade, 
                sensibilidade e conexão para fazer com que o seu negócio, seja exatamente 
                o que ele é: a materialização daquilo que está em sua mente e seu coração.<br><br>
                A quimera é um ser mitológico ligado à fantasia e à homogeneidade de 
                ideias. <br><br>
                E a Quimera Designer reflete isso: juntar as suas ideias com a nossa expertise 
                para que o resultado final da sua marca seja perfeito para você e atrativo para 
                seu cliente. Vamos juntos!</p>
            <h1 style="margin-bottom: 30px;">Identidade Visual</h1>
        </div>
    </section>
    ...
    <div class="slideshow-Container2 fade2">
        ...
        <img src="images/footer_banner2_1500x455px.png" style="width: 100%"/>
        </div>

        <div class="Containers2">

        <img src="images/footer_banner_1500x455px.png" style="width: 100%"/>
    ...
    <footer>
                ...
                <div class="container">
                    <div class="columns is-mobile">
                        <div class="column is-mobile">
                            <h1 class="title has-text-centered" style="font-weight:bold;color:#fff;">Faça um orçamento!</h1>
                            ...
                            <form action="https://getform.io/f/d3534c8d-12d8-4b73-a072-744d20ef997d" method="POST">
                                ...
                                <div class="field is-grouped">
                                    <div class="control">
                                        <button style="border-color:#FFF;font-family: Qanelas-Regular, Helvetica;background-color:#FFF;color:#24242c;font-weight:bold;" class="button is-link is-medium" >Enviar!</button>
                                    </div>
                                </div>
                            </form>
        ...
        <div class="social">
            ...
            <div class="s-m">
                ...
                <a href="https://www.facebook.com/quimera.designer"target="_blank"><i class="fab fa-facebook-f"></i></a>
